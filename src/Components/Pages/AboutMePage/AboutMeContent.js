...
export default function AboutmeContent() {
    return (
        ...
        <div style={{
            ...
            borderStyle: "solid", borderWidth: "2px", borderColor: "#209761",
            color: "#209761", borderRadius: "30px", width: "1000px"
        }}>

            <p variant="plain"
                style={{ color: "#209761", margin: "30px",fontFamily:"Exo2, sans-serif"}}>
